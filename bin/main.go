...
// Program otelcol-retrosampling is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		Command:     "otelcol-retrosampling",
		Description: "OpenTelemetry Collector with retroactive sampling processor",
		Version:     "",
	}
